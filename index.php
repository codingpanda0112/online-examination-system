...
{ 
  $sql3="select * from active where userid='".$_SESSION[login]."'";
  $rs=mysqli_query($con,$sql3);
  if(mysqli_num_rows($rs)>0)
  {
  $rs=mysqli_query($con,$sql3);
  $row=mysqli_fetch_row($rs);
  echo "<h4 align='center'> Resume  test :</h4>";
...
<table width="100%" border="0">
  <tr>
    ...
    <td width="1%" rowspan="2" bgcolor="#3145d8"><span class="style6"></span></td>
    <td width="29%" bgcolor="#3145d8"><div align="center" class="style1">User Login </div></td>
  </tr>
  <tr>
    <td height="296" valign="top"><div align="center">
      ...
      <span class="style5"><img src="image/paathshala.jpg" width="129" height="100"><span class="style7"><img src="image/HLPBUTT2.JPG" width="50" height="50"><img src="image/BOOKPG.JPG" width="43" height="43"></span>        </span>
        ...
        <param name="quality" value="high">
        <param name="BGCOLOR" value="#3145d8">
<p align="left" class="style5">&nbsp;</p>
    ...
    <td valign="top"><form name="form1" method="post" action="">
      <table width="200" border="0">
        ...
        <tr>
          <td colspan="2" bgcolor="#3145d8"><div align="center"><span class="style4">New User ? <a href="signup.php">Signup Free</a></span></div></td>
          </tr>
      </table>
      <div align="center">
